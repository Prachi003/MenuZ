                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (status.equals("true")){
                            ...
                            new Thread(() -> {
                                ...
                                /*List<ItemPreprationModel>getAllPrep=getDataManager().loadAllPrep();
                                for (ItemPreprationModel itemPreprationModel:getAllPrep){
                                    getDataManager().updateItemPrepOrder(orderID,itemPreprationModel.getPreparationId(),itemPreprationModel.getItemId());
                                }*/

                               // List<OrderAddOnChild>getAllAddon=getDataManager().loadAlladdons();



                                //List<OrderPreparationAddonModel>getAllorderprep=getDataManager().loadPreparation();
